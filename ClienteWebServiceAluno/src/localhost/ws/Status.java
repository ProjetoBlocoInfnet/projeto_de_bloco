...
public class Status implements java.io.Serializable {
    ...
    public static final java.lang.String _INATIVO = "INATIVO";
    public static final Status ATIVO = new Status(_ATIVO);
    public static final Status INATIVO = new Status(_INATIVO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost:1099/ws", "status"));
    }
    /**
